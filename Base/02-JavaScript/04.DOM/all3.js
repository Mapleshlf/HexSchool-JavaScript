...
//     data.unshift="1234";
// 	console.log(item,index,array); //item index array可自定義名稱，這裡是方便理解
// });
// console.log('hello'); //這裡是確定上面的forEach迴圈會執行完之後才執行這裡

// 陣列數字累加與變數作用域講解 知識2
// let data = [11111,2222,333,44,5];
// let total = 0;

// data.forEach(function(item,index){ //不使用array的話可以不設定參數
//     let total2 =0;
//     total2 -=item;
//     total +=item;
...
// 搭配 if，篩選出陣列裡面有幾個偶數 知識3
// let data=[30,40,100,33333,151696];
// let total = 0;
// let newData=[];
...
// 高雄 OPEN DATA-觀看免費與投幣式充電站有幾處 知識6
// 使用高雄open data
...
//     }
// });
// console.log(`高雄市的免費充電站目前共有${total.free}處`);
// console.log(`高雄市的投幣式充電站目前共有${total.paid}處`);

// 高雄 OPEN DATA-陣列物件處理 知識7
//使用陣列配合物件管理資料
...
//     }
// });
// console.log(`目前高雄市的免費充電站共有${total.free.length}處可供使用`);
// console.log(`目前高雄市的投幣式充電站共有${total.paid.length}處可供使用`);
